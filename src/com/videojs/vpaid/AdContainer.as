package com.videojs.vpaid {
  ...
  public class AdContainer extends Sprite {
    ...
    private function successfulCreativeLoad(evt: Object): void {
      ...
      _vpaidAd.addEventListener(VPAIDEvent.AdLog, function():void {
      });

      var ver = _vpaidAd.handshakeVersion("2.0");
      ...
      try {
        ...
        _model.broadcastErrorEventExternally(ExternalErrorEventName.AD_CREATIVE_VPAID_ERROR, e);
      }
    }
  }
}